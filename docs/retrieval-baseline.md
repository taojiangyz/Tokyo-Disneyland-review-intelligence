...
| Hybrid + Reranker | 0.639 | 1.000 | 0.927 | 6,763 ms |
...
Expand human judgments from 2 to at least 15 queries, preserving topic, language, market, rating, and date-filter coverage. Report per-category metrics and confidence intervals, then test smaller reranker candidate pools (10 versus 20) to quantify the quality/latency tradeoff.

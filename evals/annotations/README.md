...
Copy completed judgments into `relevance_labels.csv`, which is the versioned gold-label file consumed by the evaluator. Candidate pools can be regenerated whenever retrieval systems change.
